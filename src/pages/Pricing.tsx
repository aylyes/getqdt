  ...
  const tiers = [
    {
      ...
      features: t('tiers.starter.features', { returnObjects: true }),
    ...
    },
    {
      ...
      features: t('tiers.professional.features', { returnObjects: true }),
    ...
    },
    {
      ...
      features: t('tiers.enterprise.features', { returnObjects: true }),
      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature) => (
            <div key={feature.name} className="bg-white rounded-lg shadow-lg p-8">
