...
export function Documentation() {
  ...
  const guides = [
    {
      ...
      articles:
        t('guides.sections.gettingStarted.articles', {
          returnObjects: true,
        }) || [],
    },
    {
      ...
      articles:
        t('guides.sections.configuration.articles', {
          returnObjects: true,
        }) || [],
    },
    {
      ...
      articles:
        t('guides.sections.security.articles', {
          returnObjects: true,
        }) || [],
    },
    {
      ...
      articles:
        t('guides.sections.monitoring.articles', {
          returnObjects: true,
        }) || [],
    },
  ];
  ...
  const tutorials = (t('tutorials.items', {
    returnObjects: true,
  }) || []) as Array<{
    title: string;
    duration: string;
                ...
                <ul className="space-y-3">
                  {Array.isArray(guide.articles) &&
                    guide.articles.map((article, articleIndex) => (
                      <li key={articleIndex}>
                        <Link
                          to={`/docs/${(guide.title || '').toLowerCase()}/${(
                            article || ''
                          )
                            .toLowerCase()
                            .replace(/\s+/g, '-')}`}
